{* ECB2_Test_Template - v1.5 - 16Feb19
   ...
   Template stored in ECB2/templates/ECB2_Test_Template.tpl
      - copy template into a core:page template & create 'ECB2 Test' page
...
<h2>Test 20A: get_dropdown_from_customgs</h2>
<p>Multiple Select with size=5</p>
<p>{content_module module='ECB2' field='dropdown_from_customgs' customgs_field='Section Styles' dir='on-page-galleries' block='test20A' assign='test20A' label='Test 20A: dropdown_from_customgs' description='Description: Multiple Select with size=5' multiple=1 size=5}</p>
