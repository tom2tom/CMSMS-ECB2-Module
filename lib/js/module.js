...
(function($) {
            ...
            _injectTimePicker: function() {
                ...
                if (0 === e.find("div.ui-timepicker-div").length && t.showTimepicker) {
                    ...
                    if (this.timezone_select = f.find(".ui_tpicker_timezone").append("<select></select>").find("select"), $.fn.append.apply(this.timezone_select, $.map(t.timezoneList, (function(e, t) {
                            return $("<option></option>").val("object" == typeof e ? e.value : e).text("object" == typeof e ? e.label : e)
    ...
    function Timepicker() {
        this.regional = [], this.regional[""] = {
            currentText: "Now", // TODO langify these
            closeText: "Done",
            amNames: ["AM", "A"],
            pmNames: ["PM", "P"],
            timeFormat: "HH:mm",
...
//                history.pushState({}, '', newUrl);
    ...
    $('.ecb_repeater.sortable').sortable({
        ...
        opacity: 0.8,
        start: function(e, ui) {
            if (typeof tinyMCE !== 'undefined') { //TODO don't hardcode this type of html editor
                tinyMCE.triggerSave();
            } else {
                //TODO
            }
