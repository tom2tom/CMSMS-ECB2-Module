...
/*
NOTE this elderly JQUI addon is un-maintained, and has 451 open issues!
...
//            fieldName = ''; // required for sub_fields UNUSED here
    ...
    $('.ecb2-dropzone').each(function(i) {
        var this_ = $(this),
            ...
            thumbnail_height = this_('dropzone-thumbnail-height'),
            thumbnail_prefix = this_('dropzone-thumbnail-prefix'),
