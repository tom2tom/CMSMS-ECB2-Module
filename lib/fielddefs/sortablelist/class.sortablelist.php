...
class sortablelist extends FieldDefBase
{
    ...
    public function set_field_parameters()
    {
        ...
        $this->default_parameters = [
            ...
            'allowduplicates' => ['default' => false,    'filter' => ECB2_SANITIZE_STRING],
            ...
            'label_left' => ['default' => '',    'filter' => ECB2_SANITIZE_STRING],
            'label_right' => ['default' => '',    'filter' => ECB2_SANITIZE_STRING],
