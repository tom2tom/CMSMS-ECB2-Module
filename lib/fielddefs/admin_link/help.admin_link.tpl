...
<pre>{literal}{ECB2 field=admin_link block=test25 target='_blank' link='http://www.bing.com' text='bing search' label='25: admin_link' description='Test description (optional) can be shown here'}{/literal}</pre>
